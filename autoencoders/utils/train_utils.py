...
def log_to_wandb(prefix: str, metrics: Dict[str, float], epoch: Optional[int] = None) -> None:
    """
...
def setup_model(args: Any) -> torch.nn.Module:
    ...
    if args.model_name == 'vqvae' and args.use_ema:
        model.vector_quantizer.init_ema()
...
def evaluate_and_visualize(
    ...
    if args.visualize_similar:
        visualize_similar_images(
            model, dataloader, args.device, epoch,
